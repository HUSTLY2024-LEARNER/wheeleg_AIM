...
namespace ACTIVATOR
{
    ...
    class BuffState2BuffMeasure
    {
    public:
        template <class T>
        void operator()(const T buff_state[2], T buff_measure[2])
        {
            buff_measure[0] = buff_state[0];
        }
    };
    ...
    private:
        ExtendedKalman<double, 2, 1> *kalman_filter; // 滤波二维
        BuffState2BuffMeasure buff_state_to_measure;
        bool is_kalman_init;
